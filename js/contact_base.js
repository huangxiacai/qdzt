...
function initMap(){
    ...
    function createMap(){
        ...
        var point = new BMap.Point(120.324339,36.304748);//定义一个中心点坐标
    ...
    map.addControl(ctrl_nav);//向地图中添加比例尺控件
    var ctrl_sca = new BMap.ScaleControl({anchor:BMAP_ANCHOR_BOTTOM_LEFT});
    map.addControl(ctrl_sca);
    }//标注点数组
    var markerArr = [{title:"青岛智腾微电子有限公司",content:"<img src=/images/mc.jpg width=280><br>地址：中国青岛高新区锦业路1号A3座<br/>电话：0086-0532-58717256
",point:"120.324339|36.304748",isOpen:0,icon:{w:23,h:25,l:46,t:21,x:9,lb:12}}
         ];//创建marker
    function addMarker(){
