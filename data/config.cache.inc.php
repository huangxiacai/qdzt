...
$cfg_basehost = 'http://www.ztmicro.com';
$cfg_cmspath = '';
$cfg_cookie_encode = 'ewPimKi5HoGcfBEohrgn0FWIg0g03hd';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '主页';
$cfg_webname = '混合集成电路_高精度传感器_惯性导航_高温存储器-青岛智腾微电子';
...
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright ©2016 青岛智腾微电子有限公司';
$cfg_arcsptitle = 'Y';
$cfg_arcautosp = 'Y';
$cfg_arcautosp_size = 10;
...
$cfg_rewrite = 'Y';
$cfg_delete = 'Y';
$cfg_keywords = '青岛智腾微电子';
$cfg_description = '青岛智腾微电子成立于2002年,专注混合集成电路、高精度传感器、惯性导航、高温存储器设计研发和制造.产品具有精度高、耐高温、体积小等特点,广泛应用航空航天、军用科研等领域.';
$cfg_beian = '鲁ICP备17015352号-1';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
$cfg_typedir_df = 'Y';
...
$cfg_protel = '<h2>销售联系：<em>13668861000</em></h2>
<p>青岛智腾微电子有限公司<br />地址：青岛高新区锦业路1号A3座<br />
电话：+86-0532-68013919<br />传真：+86-0532-58717256-8018<br />
邮件：<a href="mailto:sales@qdzitn.com">sales@qdzitn.com</a></p>';
?>